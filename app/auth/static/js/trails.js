    ...
    function openModal(trail) {
        ...
        modalContent.innerHTML = `
            ...
            <div class="modal-body">
                ...
                <!-- Live Tracking Link Section (TASK 5) -->
                <div class="modal-section" style="margin-top: 30px; text-align: center;">
                    <a href="tracking.html?trail=${encodeURIComponent(trail.name)}" class="btn-primary" style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; text-decoration: none; width: auto; padding: 12px 30px; border-radius: 10px;">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                            <circle cx="12" cy="10" r="3"></circle>
                        </svg>
                        Start Tracking This Hike
                    </a>
                </div>
            </div>
        `;
